  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-auto">
      ...
      <motion.div
        ...
        className="relative z-10 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-[700px] w-full max-h-[90vh] p-8 flex flex-col gap-8 overflow-y-auto"
      >
        {/* CLOSE BUTTON */}
        <button
          onClick={onClose}
        ...
        <div className="bg-gray-50 dark:bg-gray-900 dark:border dark:border-[#748dff] p-6 rounded-xl flex flex-col gap-4 shadow-sm">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="grid grid-cols-2 gap-6 w-full">
              ...
              <InfoBox icon={<FiMail className="text-green-500 text-xl" />} label="Email" value={complaint.userId?.email} />
        ...
        <div className="bg-gray-50 dark:bg-gray-900 dark:border dark:border-[#748dff] p-6 rounded-xl flex flex-col gap-6 shadow-sm">
          ...
          <div className="flex items-start justify-between gap-4 w-full">
            {/* Type Box */}
            <div className="flex items-start gap-2 p-3 bg-gray-100 dark:bg-gray-700 rounded-xl shadow-sm flex-1">
              ...
              <div className="flex flex-col mt-1">
                ...
                <span className="px-3 py-1 rounded-full text-[#6e11b0] bg-[#f3e8ff] font-medium text-sm mt-1">
            ...
            {/* Status Box */}
            <div className={`flex items-start gap-2 p-3 rounded-xl shadow-sm flex-1 ${statusColor[status] || statusColorDefault}`}>
          ...
          <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg shadow-sm">
            ...
            <p className="text-gray-800 dark:text-gray-200">{complaint.message}</p>
          </div>
        </div>
        ...
        <div className="flex gap-4 mt-4">
          <button
            onClick={onClose}
            className="flex-1 bg-gray-200 dark:bg-gray-700 px-5 py-3 rounded-lg font-medium hover:bg-gray-300 dark:hover:bg-gray-600 cursor-pointer"
          >
            Close
          </button>
          <button
